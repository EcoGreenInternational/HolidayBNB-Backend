...
import { getProperties, getPropertyById, getBookedDates, seedProperties } from '../controllers/propertyController.js';
...
router.route('/:id/booked-dates').get(mongoIdParam('id'), validate, getBookedDates);
